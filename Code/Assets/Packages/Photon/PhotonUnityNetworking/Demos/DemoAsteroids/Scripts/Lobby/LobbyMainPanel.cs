...
namespace Photon.Pun.Demo.Asteroids
{
    public class LobbyMainPanel : MonoBehaviourPunCallbacks
    {
        ...
        private const int MAX_PLAYERS_IN_ROOM = 5;
        ...
        public override void OnJoinRandomFailed(short returnCode, string message)
        {
            ...
            RoomOptions options = new RoomOptions {MaxPlayers = MAX_PLAYERS_IN_ROOM};
        ...
        public override void OnJoinedRoom()
        {
            ...
            foreach (Player p in PhotonNetwork.PlayerList)
            {
                ...
                // {
                //     StartCoroutine(entry.GetComponent<PlayerListEntry>().Timer());
        ...
        public override void OnPlayerEnteredRoom(Player newPlayer)
        {
            ...
            // if (PhotonNetwork.CurrentRoom.PlayerCount == PhotonNetwork.CurrentRoom.MaxPlayers)
            // {
            //     foreach (var playerListEntry in FindObjectsOfType<PlayerListEntry>())
            //     {
            //         StartCoroutine(playerListEntry.Timer());
            //         StartCoroutine(StartGameTimer());
            //     }
            // }
        }
        ...
        public void OnCreateRoomButtonClicked()
        {
            ...
            maxPlayers = (byte) Mathf.Clamp(maxPlayers, 2, MAX_PLAYERS_IN_ROOM);
